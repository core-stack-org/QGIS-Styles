...
<qgis hasScaleBasedVisibilityFlag="0" autoRefreshMode="Disabled" minScale="1e+08" styleCategories="LayerConfiguration|Symbology|MapTips|AttributeTable|Rendering|CustomProperties|Temporal|Elevation|Notes" maxScale="0" version="3.40.5-Bratislava" autoRefreshTime="0">
  <flags>
  ...
  <elevation zoffset="0" zscale="1" band="1" mode="RepresentsElevationSurface" enabled="0" symbology="Line">
    ...
    <profileLineSymbol>
      <symbol name="" type="line" frame_rate="10" alpha="1" is_animated="0" force_rhr="0" clip_to_extent="1">
        ...
        <layer locked="0" pass="0" enabled="1" class="SimpleLine" id="{2919615a-ee8e-496b-abf8-93730fab62a8}">
          <Option type="Map">
    ...
    <profileFillSymbol>
      <symbol name="" type="fill" frame_rate="10" alpha="1" is_animated="0" force_rhr="0" clip_to_extent="1">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" type="QString" value=""/>
            <Option name="properties"/>
        ...
        <layer locked="0" pass="0" enabled="1" class="SimpleFill" id="{555cd087-bc4e-4409-9f97-3f6172d91044}">
          <Option type="Map">
  ...
  <FileBasedAttributeTables>
    <AttributeTable band="1" path="/Users/raman/Downloads/Land Degradation 2015 2016 2/ldd1516.tif.vat.dbf"/>
  </FileBasedAttributeTables>
  ...
  <paletteEntry alpha="255" color="#d9d9d9" label="Data_Not_Available" value="37"/>
    ...
    <huesaturation colorizeBlue="128" saturation="0" invertColors="0" colorizeRed="255" colorizeStrength="100" grayscaleMode="0" colorizeOn="0" colorizeGreen="128"/>

...
<qgis minScale="1e+08" styleCategories="AllStyleCategories" maxScale="0" hasScaleBasedVisibilityFlag="0" version="3.38.2-Grenoble">
  ...
  <pipe>
    ...
    <rasterrenderer opacity="1" classificationMin="0" band="1" nodataColor="" classificationMax="5" type="singlebandpseudocolor" alphaBand="-1">
      <rasterTransparency/>
      <minMaxOrigin>
        <limits>None</limits>
      ...
      <rastershader>
        <colorrampshader clip="0" minimumValue="0" colorRampType="INTERPOLATED" labelPrecision="0" classificationMode="2" maximumValue="5">
          ...
          <item alpha="255" label="Trees-Trees" value="1" color="#73bb53"/>
          <item alpha="255" label="Built_Up-Trees" value="2" color="#ff0000"/>
          <item alpha="255" label="Crops-Trees" value="3" color="#eee05d"/>
          <item alpha="255" label="Barren-Trees" value="4" color="#a9a9a9"/>
          <item alpha="255" label="Shrubs_and_Scrubs-Trees" value="5" color="#eaa4f0"/>

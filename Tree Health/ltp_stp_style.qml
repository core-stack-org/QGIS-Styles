...
<qgis styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0" minScale="1e+08" version="3.38.2-Grenoble" maxScale="0">
  <flags>
  ...
  <elevation enabled="0" band="1" mode="RepresentsElevationSurface" zscale="1" symbology="Line" zoffset="0">
    ...
    <profileLineSymbol>
      <symbol type="line" is_animated="0" force_rhr="0" name="" alpha="1" clip_to_extent="1" frame_rate="10">
        ...
        <layer enabled="1" pass="0" locked="0" id="{2f0b3c0d-0b26-4a61-a649-d2ce1d453570}" class="SimpleLine">
          <Option type="Map">
    ...
    <profileFillSymbol>
      <symbol type="fill" is_animated="0" force_rhr="0" name="" alpha="1" clip_to_extent="1" frame_rate="10">
        ...
        <layer enabled="1" pass="0" locked="0" id="{30ee8f00-8274-441e-85f4-03d107de357e}" class="SimpleFill">
          <Option type="Map">
  ...
  <pipe>
    ...
    <rasterrenderer nodataColor="" band="1" type="singlebandpseudocolor" alphaBand="-1" opacity="1" classificationMin="0" classificationMax="7">
      <rasterTransparency/>
      <minMaxOrigin>
      ...
      <rastershader>
        <colorrampshader colorRampType="INTERPOLATED" minimumValue="0" clip="0" classificationMode="1" maximumValue="7" labelPrecision="0">
    ...
    <huesaturation saturation="0" colorizeOn="0" colorizeStrength="100" colorizeBlue="128" invertColors="0" grayscaleMode="0" colorizeRed="255" colorizeGreen="128"/>

...
<qgis version="3.34.15-Prizren" hasScaleBasedVisibilityFlag="0" maxScale="0" autoRefreshTime="0" minScale="1e+08" styleCategories="AllStyleCategories" autoRefreshMode="Disabled">
  <flags>
  ...
  <elevation symbology="Line" zscale="1" zoffset="0" band="1" enabled="0">
    ...
    <profileLineSymbol>
      <symbol name="" is_animated="0" alpha="1" type="line" frame_rate="10" clip_to_extent="1" force_rhr="0">
        ...
        <layer class="SimpleLine" pass="0" locked="0" id="{53250ab4-e1c0-4e89-9f83-2908ea6bf902}" enabled="1">
          <Option type="Map">
    ...
    <profileFillSymbol>
      <symbol name="" is_animated="0" alpha="1" type="fill" frame_rate="10" clip_to_extent="1" force_rhr="0">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" value="" type="QString"/>
            <Option name="properties"/>
        ...
        <layer class="SimpleFill" pass="0" locked="0" id="{30da0671-8ae3-4bd0-9b32-787a7db7749e}" enabled="1">
          <Option type="Map">
  ...
  <pipe>
    ...
    <rasterrenderer alphaBand="-1" type="singlebandpseudocolor" nodataColor="" classificationMax="2000" band="1" opacity="1" classificationMin="0">
      <rasterTransparency/>
      <minMaxOrigin>
        <limits>None</limits>
      ...
      <rastershader>
        <colorrampshader labelPrecision="0" classificationMode="2" colorRampType="DISCRETE" maximumValue="2000" clip="0" minimumValue="0">
    ...
    <huesaturation colorizeBlue="128" invertColors="0" grayscaleMode="0" colorizeRed="255" colorizeOn="0" colorizeGreen="128" saturation="0" colorizeStrength="100"/>

...
<qgis version="3.28.9-Firenze" hasScaleBasedVisibilityFlag="0" minScale="1e+08" styleCategories="AllStyleCategories" maxScale="0">
  <flags>
  ...
  <elevation band="1" zscale="1" enabled="0" symbology="Line" zoffset="0">
    ...
    <profileLineSymbol>
      <symbol alpha="1" is_animated="0" frame_rate="10" type="line" force_rhr="0" clip_to_extent="1" name="">
    ...
    <profileFillSymbol>
      <symbol alpha="1" is_animated="0" frame_rate="10" type="fill" force_rhr="0" clip_to_extent="1" name="">
        <data_defined_properties>
          <Option type="Map">
            <Option type="QString" value="" name="name"/>
            <Option name="properties"/>
  ...
  <pipe>
    ...
    <rasterrenderer band="1" type="singlebandpseudocolor" nodataColor="" alphaBand="-1" opacity="1" classificationMin="0" classificationMax="10.0001802">
      <rasterTransparency/>
      <minMaxOrigin>
      ...
      <rastershader>
        <colorrampshader colorRampType="DISCRETE" clip="0" classificationMode="2" labelPrecision="4" maximumValue="10.000180200000001" minimumValue="0">
          <colorramp type="gradient" name="[source]">
            <Option type="Map">
              <Option type="QString" value="255,255,204,255" name="color1"/>
              <Option type="QString" value="153,0,0,255" name="color2"/>
    ...
    <huesaturation invertColors="0" colorizeRed="255" colorizeGreen="128" colorizeOn="0" grayscaleMode="0" colorizeBlue="128" saturation="0" colorizeStrength="100"/>

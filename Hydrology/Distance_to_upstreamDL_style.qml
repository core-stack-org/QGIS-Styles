...
<qgis version="3.28.9-Firenze" hasScaleBasedVisibilityFlag="0" minScale="1e+08" styleCategories="AllStyleCategories" maxScale="0">
  ...
  <pipe>
    ...
    <rasterrenderer band="1" type="singlebandpseudocolor" nodataColor="" alphaBand="-1" opacity="1" classificationMin="0" classificationMax="9999999999">
      <rasterTransparency/>
      <minMaxOrigin>
        <limits>None</limits>
      ...
      <rastershader>
        <colorrampshader colorRampType="DISCRETE" clip="0" classificationMode="2" labelPrecision="4" maximumValue="9999999999" minimumValue="0">
          ...
          <item label="> 2000.0000" alpha="255" value="inf" color="#7d0b1b"/>
